...
import FS1 from '../../public/images/1 (3).png';
import FS2 from '../../public/images/2 (3).png';
import FS3 from '../../public/images/3 (3).png';
import FS4 from '../../public/images/4 (2).png';
...
function FlashSales() {
  return (
    <div className="flex flex-col gap-5 mx-6 sm:mx-12 md:mx-24 my-16 sm:my-24 border-b">
      ...
      {/* Flash Sale Timer and Navigation */}
